...
public class SwerveModuleFactory<DriveConfiguration, SteerConfiguration> {
    ...
    private static class ModuleImplementation implements SwerveModule {
        ...
        public double getDrivePosition() {
            return this.driveController.getPosition();
        }

        @Override
        public void setDrivePosition(double pos) {
            this.driveController.setPosition(pos);
        }

        @Override
        public double getSteerCurrentOutput() {
            return this.steerController.getSteerCurrentOutput();
        }

        @Override
        public double getSteerID() {
            return this.steerController.getID();
        }
